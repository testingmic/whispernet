<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center">
                        ...
                        <div class="text-center">
                            ...
                            <div class="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-12">                                
                                <div class="bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-white/20 dark:border-gray-700/30">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-400 text-sm">Your data stays private and secure</p>
                                </div>
