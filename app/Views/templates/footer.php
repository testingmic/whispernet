    ...
    <div class="max-w-7xl mx-auto px-4">
      <div class="flex justify-around">
        ...
        <?php if (empty($noInstallation)) { ?>
          <!-- PWA Install Button -->
          <button id="installButton" class="flex hidden flex-col items-center justify-center px-4 py-3 rounded-xl transition-all duration-300 group text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20">
            <div class="relative">
